...
public class Worker : Unit
{
    ...
    {
        base.Start();
        actions = new string[] { "Refinery", "Barraks","sMITH" };
    }
    ...
    public override void SetBuilding(Building project)
    {
        ...
        Vector3 build_pos = new(currentProject.transform.position.x, 0.0f, currentProject.transform.position.z);
        StartMove(build_pos, currentProject.gameObject);
        building = true;
    }
